...
import { removePizza } from '../redux/actions/cart';
  ...
  return (
    <div class="cart__item">
      ...
      <div class="cart__item-info">
        <h3>{pizza.name}</h3>
        <p>{`${pizza.types === 0 ? 'тонкое' : 'традиционное'}, ${pizza.sizes} см.`}</p>
      </div>
      ...
      <div class="cart__item-remove" onClick={() => dispatch(removePizza(pizza))}>
